...
KERNEL="Image"
DTBIMAGE="dtb"
export CLANG_PATH=~/android/Toolchains/clang/clang11_2/bin/
...
export KBUILD_COMPILER_STRING=$(~/android/Toolchains/clang/clang11_2/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')
